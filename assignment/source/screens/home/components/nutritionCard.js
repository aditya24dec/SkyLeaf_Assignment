  ...
  return (
    <View style={Styling.nutritionCardStyle}>
      ...
      <TextRow
        ...
        weight="0.02g"
        rightText="0%"
        isBottomBorderLight={true}
      />
      <SubTextRow
        leftText="Saturated fat 0.3g"
        rightText="0%"
        isBottomBorderLight={true}
        isSubText={true}
      />
      ...
      />
      <TextRow
        leftText="Total carbohydrate "
        weight="23g"
        rightText="8%"
        isBottomBorderLight={true}
      />
      <SubTextRow
        leftText="Dietary fiber 2.6g"
        rightText="9%"
        isBottomBorderLight={true}
        isSubText={true}
      />
      ...
      />
      <SubTextRow
        leftText="Vitamin D 0.00mcg"
        rightText="0%"
        isBottomBorderLight={true}
      />
      <SubTextRow
        leftText="Calcium 5.00mg"
        rightText="0%"
        isBottomBorderLight={true}
      />
      <SubTextRow
        leftText="Iron 0.26mg"
        rightText="0%"
        isBottomBorderLight={true}
      />
      <SubTextRow
        leftText="Potassium 358mg"
        rightText="0%"
        isBottomBorder={true}
      />
  ...
  return (
    <View
      ...
      <Text
        ...
        {props.leftText}
        {props.weight ? (
          <Text style={[Styling.rowTextStyle, {color: '#999'}]}>
            {props.weight}
          </Text>
        ) : null}
      </Text>
