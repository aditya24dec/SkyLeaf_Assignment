    ...
    <View style={Styling.bottomContainer}>
      <View style={[Styling.delTextConatiner, Styling.borderBottom]}>
        ...
        <View style={Styling.delTextFlex}>
          <Text style={Styling.delTextStyle}>
      ...
      <View style={[Styling.bottomTextContainer, Styling.borderBottom]}>
        ...
        <View style={Styling.contentTextContainer}>
          <Text style={[Styling.bottomTextStyle, {color: '#999'}]}>
            Leading the Crops Divsion for Demo Group is india's best branded
            fruit company and a market leader in controlled cultivation and
            marketing on high-quality fruits for domestic and international
            customers in socially responsible manner.
          </Text>
        </View>
        <View style={Styling.contentTextContainer}>
          <Text style={[Styling.bottomTextStyle, {color: '#999'}]}>
            We are happy to server fresh and delicious fruits
          </Text>
        </View>
      </View>
    </View>
